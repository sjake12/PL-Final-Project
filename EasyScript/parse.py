        ...
        if self.token.value == "say":
            ...
            if self.token.value == "(":
                ...
                if self.token.value == ")":
                    ...
                    raise SyntaxError("Expected closing parenthesis ')' after message in say statement")
            else:
                raise SyntaxError("Expected opening parenthesis '(' after 'say' keyword")

    def statement(self):
        # Check for the "say" statement first
        say_message = self.say_statement()
        if say_message:
            return say_message
